...
var mergeTwoLists = function(list1, list2) {
    ...
    //actually array is not needed, we can create infinite loop and jump from list 1 to list 2 if smaller distance found, then compare to the next of list 2 to again next of list 1.. and we need to record which node we are progressing for list 1 as well as list 2.
if(list1 == null){
    return list2
}else if(list2== null){
    return list1
